...
{
	GPIO_WriteBit(LED2_GPIO_PORT, LED2_GPIO_PIN, (BitAction)((1-GPIO_ReadOutputDataBit(LED2_GPIO_PORT, LED2_GPIO_PIN))));//led电平翻转
}
void LED2_On()
{
	GPIO_WriteBit(LED2_GPIO_PORT, LED2_GPIO_PIN,(BitAction)1);
}
void LED2_Off()
{
	GPIO_WriteBit(LED2_GPIO_PORT, LED2_GPIO_PIN,(BitAction)0);
}
